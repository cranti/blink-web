...
%       Col 2 - Blink start time (integers) Col 3 - Blink stop time
%       (integers)
% > sampleLen - length of the clip sampled. This will determine the number
% of columns in the output matrix
%
% Outputs:
% > n x f matrix with 1s (blink frames) and 0s (non-blink frames)
...
%  - Not a whole lot of error checking going on.
% 
% Carolyn Ranti
% 12.3.2014 
